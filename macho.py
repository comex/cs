...
LoadCommand = Struct("LoadCommand",
    ...
    Peek(Switch("data", lambda ctx: ctx['cmd'], {
        'LC_SEGMENT': Struct('segment',
            ...
            UInt32('nsects'),
            UInt32('flags'),
            Rename("sections", StrictRepeater(lambda ctx: ctx['nsects'], Struct('Section',
...
MachO = Struct("MachO",
    ...
    If(lambda ctx: ctx['magic'] == 'MH_MAGIC_64', UInt32('reserved')),
    Rename('commands', StrictRepeater(lambda ctx: ctx['ncmds'], LoadCommand))
)
...
Fat = Struct("Fat",
    HexAdapter(Const(UBInt32("magic"), 0xcafebabe)),
    UBInt32("nfat_arch"),
